var pageEvent = {
    ...
    openAddEventModal: function(){
        ...
        pageEvent.subEventCount = 0;
        $('.removeDiv').remove();

        //hide the submenu & button
        $(".mainEventDiv").removeClass("hidden");
        $("#subEventAddDiv").addClass("hidden");

        $('#eventModalHeading').empty().html("Add Event");
        $("#eventModal").modal("show");
    },
    openEventInviteListModal: function(){
    ...
    subEventConfirmation: function(){
        ...
        if(eventConfirm == 0) {
            ...
            $("#subEventAddDiv").removeClass("hidden");
