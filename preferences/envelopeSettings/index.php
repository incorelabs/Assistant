...
<div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModal" aria-hidden="true"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="progress hidden" id="envelopeSettingsUploadProgress">
                <div class="progress-bar" id="envelopeSettingsUploadProgressBar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                     style="width: 0%;">
                    <span class="sr-only" id="envelopeSettingsUploadProgressValue">0% Complete</span>
                </div>
            </div>
        </div>
        <!--modal-content-->
