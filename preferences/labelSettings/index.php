...
<div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModal" aria-hidden="true"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                        ...
                        <center>
                            <div class="col-sm-12 col-md-12">
                                <div class="col-lg-6 col-md-6 col-sm-5">
                                    ...
                                    <br>
                                    <div class='input-group'>
                                        <input id='labelImgInputPath' name='labelImgInputPath' class='form-control' placeholder='Choose File' disabled='disabled' />
            ...
            <div class="progress hidden" id="labelSettingsUploadProgress">
                <div class="progress-bar" id="labelSettingsUploadProgressBar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                     style="width: 0%;">
                    <span class="sr-only" id="labelSettingsUploadProgressValue">0% Complete</span>
                </div>
            </div>
        </div>
        <!--modal-content-->
