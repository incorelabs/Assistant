...
<div class="container">
    ...
    <div class="row button-top-margin" style="position:relative;">
        ...
        <div class="text-center row-desc-margin"><h4 id="voucherHeader">Income Description</h4></div>
...
<div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModal" aria-hidden="true"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="progress hidden" id="incomeVoucherUploadProgress">
                <div class="progress-bar" id="incomeVoucherUploadProgressBar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                     style="width: 0%;">
                    <span class="sr-only" id="incomeVoucherUploadProgressValue">0% Complete</span>
                </div>
            </div>
        </div>
        <!--modal-content-->
