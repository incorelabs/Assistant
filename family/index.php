		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<label class="col-xs-4 control-label">Name</label>
					<div class="col-xs-7">
						<div class="inner-addon right-addon">
							...
							<input type="text" name="name" id="firstName" class="form-control name" placeholder="Name"/>
							<div class='info'></div>
						</div>
					</div>
				</div>
				<div class="form-group form-group-margin">
					<label class="col-xs-4 control-label">Relation</label>
					<div class="col-xs-7">
						<div class="inner-addon right-addon">
							<i class="fa fa-star" style="font-size:16px"></i>
							<select name="relation" class="form-control textbox_height" id="relation">
							</select>
							<div class='info'></div>
						</div>
					</div>
				...
				<div class="form-group form-group-margin">
					...
					<div class="col-xs-7">
						<div class="inner-addon right-addon">
							...
							<input type="text" name="dob" id="dob" class="form-control date" placeholder="Date of Birth"/>
							<div class='info'></div>
						</div>
					</div>
				</div>
				...
				<div class="form-group form-group-margin">
					...
					<div class="col-xs-7">
						<div class="inner-addon right-addon">
							<i class="glyphicon glyphicon-phone" style="font-size:16px"></i>
				...
				<div class="form-group form-group-margin">
					...
					<div class="col-xs-7">
						<div class="inner-addon right-addon">
							<i class="fa fa-caret-down fa-lg" style="font-size:16px;right:12px"></i>
							<select name="gender" id='gender' class="form-control textbox_height">
				...
				<div class="form-group form-group-margin">
					...
					<div class="col-xs-7">
						<div class="radio">
							<div class="col-xs-4">
							    <label>
							    	<input type="radio" name="access" id="yes" onclick="showhidediv(this);" value="1">Yes</input>
							    </label>
							</div>
							<div class="col-xs-4">
							    <label>
							    	<input type="radio" name="access" id="no" onclick="showhidediv(this);" checked="checked" value="2">No</input>
							    </label>
						    </div>
						</div>
						<div class='info'></div>
				...
				<div id="loginAccess" style="display:none">
					...
					<div class="form-group form-group-margin">
						...
						<div class="col-xs-7">
							<div class="inner-addon right-addon">
								<i class="fa fa-key" style="font-size:16px"></i>
								<input type="password" name="confirmPassword" id="confirmPassword" class="form-control c_password" placeholder="Confirm Password" />
								<div class='info'></div>
							</div>
						</div>
					</div>
