...
class ExpenseDetail
{
    ...
    function getExpenseDetailQuery(){
        $sql = "SELECT Table171.RegCode, Table171.ExpenseCode, Table171.ExpenseTypeCode, Table123.ExpenseTypeName, Table171.HolderCode, Table107.FamilyName as 'HolderName', Table171.ExpenseName, Table171.JointHolder, Table171.ExpenseRemarks, Table171.ExpenseFrequency, Table171.ContactCode ,Table151.FullName, Table171.BillingDay, Table171.DueDay, DATE_FORMAT(Table171.ExpiryDate,'%d/%m/%Y') AS 'ExpiryDate', Table171.PayWebsite, Table171.InsertedBy, Table171.PrivateFlag, Table171.ActiveFlag, Table171.LastAccessDate FROM Table171 INNER JOIN Table123 ON Table123.ExpenseTypeCode = Table171.ExpenseTypeCode INNER JOIN Table107 ON Table107.RegCode = Table171.RegCode AND Table107.FamilyCode = Table171.HolderCode LEFT JOIN Table151 ON Table151.RegCode = Table171.RegCode AND Table151.ContactCode = Table171.ContactCode WHERE Table171.RegCode = ".$this->regCode." AND Table171.ExpenseCode = ".$this->expenseCode." ORDER BY Table107.FamilyName LIMIT 1";
        return $sql;
    }
