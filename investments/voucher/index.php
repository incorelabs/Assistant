...
<head>
    ...
    <title>Assistant - Investments Voucher</title>
    <?php
    include_once ROOT . 'dist/fetchCSS.php';
    ?>
    <link rel="stylesheet" href="../../dist/investmentsVoucher/css/style.css"/>
</head>
<body>
<!-- fixed top navbar -->
<?php
define('PAGE_TITLE', 'Voucher');
$root_location = ROOT;
...
<div class="container">
    ...
    <div class="row button-top-margin" style="position:relative;">
        <div class="text-left">
            <button class="btn btn-primary" id="btnAddVoucher" onclick="pageInvestmentVoucher.navigateBack();">
                <i class="fa fa-arrow-left fa-lg"></i>
            </button>
        </div>
        <div class="text-center row-desc-margin"><h4 id="voucherHeader"></h4></div>
        <div class="text-right row-right-btn-margin">
            <button class="btn btn-primary" id="btnAddVoucher" onclick="pageInvestmentVoucher.openAddVoucherModal();">
        ...
        <table class="table table-top-margin borderless">
            ...
            <tr class="text-left">
                ...
                <td class="col-md-1 col-sm-1 col-xs-1 text-left text-middle">
                    <div class="image"><a onclick="pageInvestmentVoucher.openLogoVoucherModal(0);" class="clickable"><img
                                src="../../img/default/preferences/logo.png"
                ...
                <td class="col-md-1 hidden-xs hidden-sm text-left text-middle">Service</td>
                <td class="col-md-1 hidden-xs hidden-sm text-left text-middle">01/01/2001</td>
                <td class="col-md-1 hidden-xs hidden-sm text-left text-middle">Cash</td>
                <td class="col-md-1 hidden-xs hidden-sm text-left text-middle">-</td>
                <td class="col-md-1 hidden-xs hidden-sm text-left text-middle">-</td>
                <td class="col-md-1 hidden-xs hidden-sm text-left text-middle">-</td>
                <td class="col-md-1 col-sm-1 col-xs-1 text-left text-middle">5000.00</td>
                <td class="col-md-1 hidden-xs hidden-sm text-left text-middle">-</td>
                <td class="col-md-1 col-sm-1 col-xs-1 text-middle"><a href="#"
                                                                      onclick="pageInvestmentVoucher.openEditVoucherModal(0)"><i
                            class="fa fa-pencil fa-lg fa-green"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"
                                                                                                         onclick="pageInvestmentVoucher.openDeleteVoucherModal(1001)"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" action="controller.php" id="voucherForm" autocomplete="off">
                ...
                <input type="text" class="hidden" name="InvestmentCode" id="investmentCodeForAddEditVoucher"/>
                ...
                <div class="modal-body">
                    <div class="btn-group">
                        <form method="POST" action="controller.php" id="deleteVoucherForm">
                            ...
                            <input type="text" class="hidden" name="investmentCode"
                                   id="investmentCodeForDeleteVoucher"/>
...
<div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModal" aria-hidden="true"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                        ...
                        <center>
                            <div class="col-sm-12 col-md-12">
                                <div class="col-lg-6 col-md-6 col-sm-5">
                                    ...
                                    <div class='input-group'>
                                        <input id='investmentImgInputPath' name='investmentImgInputPath'
                                    ...
                                    <div class="delete-btn-padding">
                                        <button type="button" class="btn btn-danger" id="deleteImageBtn"
                                                onclick="pageInvestmentVoucher.deleteCurrentLogo();">
                                            Delete Image
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="progress hidden" id="investmentVoucherUploadProgress">
                <div class="progress-bar" id="investmentVoucherUploadProgressBar" role="progressbar" aria-valuenow="0"
                     aria-valuemin="0" aria-valuemax="100"
                     style="width: 0%;">
                    <span class="sr-only" id="investmentVoucherUploadProgressValue">0% Complete</span>
                </div>
            </div>
        </div>
        <!--modal-content-->
...
?>
<script src="../../dist/investmentsVoucher/script/script.js"></script>
