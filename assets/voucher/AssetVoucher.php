...
class AssetVoucher
{
    ...
    function __construct($assetCode){
        ...
        $this->where = " WHERE RegCode = ".$this->regCode." AND AssetCode = ".$this->assetCode;
    }
    ...
    function getImagePath($voucherNo){
        $sql = "SELECT ImagePath FROM Table166 ".$this->where." AND SerialNo = ".$voucherNo." LIMIT 1";
        if($result = $this->mysqli->query($sql)){
    ...
    function getDeleteQuery(){
        return "DELETE FROM Table164".$this->where." AND VoucherNo = ".$this->data['voucherNo'];
    }
    ...
    function deleteVoucherImagePath(){
        ...
        $sql = "UPDATE Table164 SET PhotoUploaded = 2 WHERE RegCode = ".$this->regCode." AND AssetCode = ".$this->assetCode." AND VoucherNo = ".$this->data["voucherNo"].";";
        $sql .= "DELETE FROM Table166 WHERE RegCode = ".$this->regCode." AND AssetCode = ".$this->assetCode." AND SerialNo = ".$this->data["voucherNo"].";";
        $this->runMultipleQuery($sql);
    }
    ...
    function generateVoucherCode(){
        $voucherCode = 1001;
        $sql = "SELECT MAX(VoucherNo) AS 'voucherCode' FROM Table164".$this->where;
        if($result = $this->mysqli->query($sql)){
