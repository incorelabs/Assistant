					...
					<div class="panel-body">
						<div class="form-group">
							<div class="inner-addon right-addon">
								...
								<input type="text" class="form-control textbox_height" placeholder="Email ID" autofocus="true" />
							</div>
						</div>
						<div class="form-group">
							<div class="inner-addon right-addon">
						...
						<div class="form-group">
							<div class="inner-addon right-addon">
							    <i class="fa fa-key" style="font-size: 20px;"></i>
								<input type="password" class="form-control textbox_height" placeholder="Confirm Password" />
							</div>
						</div>
						<hr />
						<div class="form-group">
							<div class="inner-addon right-addon">
							    <i class="fa fa-user" style="font-size: 20px;"></i>
								<input type="text" class="form-control textbox_height" placeholder="Name" />
							</div>
						</div>
						<div class="form-group">
						        <div class="inner-addon right-addon">
						...
						<div class="form-group">
							...
							<div class="inner-addon right-addon">
								...
								<input type="number" class="form-control textbox_height mobile" id="mobile" placeholder="Mobile" />
							</div>
						</div>
						<div class="form-group">
							<div class="inner-addon right-addon">
							    <i class="fa fa-calendar" style="font-size: 20px;"></i>
								<input type="" class="form-control textbox_height" placeholder="Date of Birth" />
							</div>
						</div>
					</div>
