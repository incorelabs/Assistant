               			...
               			<div class="panel-body">
							<div class="form-group">
								<div class="inner-addon left-addon">
									...
									<input type="email" class="form-control textbox_height" name="email" id="forgotEmail" placeholder="Email" autofocus="true"/>
									<div class="info"></div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="inner-addon left-addon">
									...
									<input type="text" class="form-control textbox_height" name="mobile" id="forgotMobile" placeholder="Mobile"/>
									<div class="info"></div>
								</div>
							</div>
						</div>
